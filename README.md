...
Generated Android Trusted Web Activity (TWA) project for **باقتك**.
...
| App name | باقتك |
| Short name | باقتك |
| Package ID | `com.baqtak.app` |
| Website URL | https://baqtak.com/ |
| Verified host | baqtak.com |
| Description | أشحن - تعلّم - صمّم - أنجز واستمتع بكل الخدمات |
| Generated at | 2026-08-29 12:01:56 UTC |
...
```text
https://baqtak.com/.well-known/assetlinks.json
```
